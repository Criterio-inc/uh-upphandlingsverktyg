...
export default function MognadmatningSurveyPage({
  params,
}: {
            ...
            <form onSubmit={handleStartSurvey} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="t.ex. IT-chef, Verksamhetsutvecklare"
                  className="w-full rounded-xl border border-border bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-ring/40"
                />
              </div>
              <div className="pt-2">
      ...
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <div className="w-full max-w-lg text-center">
          ...
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-emerald-100 dark:bg-emerald-900/30 mx-auto mb-6">
            <Icon name="check-circle" size={32} className="text-emerald-600 dark:text-emerald-400" />
          </div>
          <h1 className="text-2xl font-semibold tracking-tight text-foreground mb-2">
            Tack för dina svar!
          </h1>
    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-8">
        <div className="w-full max-w-xl">
          {/* Dimension tag */}
          <div className="mb-4">
            <span className="text-[11px] font-medium px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400">
              {dimensionLabel}
            </span>
          </div>
