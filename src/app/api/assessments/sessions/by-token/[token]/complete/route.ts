...
/* ------------------------------------------------------------------ */
/*  POST /api/assessments/sessions/by-token/[token]/complete            */
...
export async function POST(
  ...
  try {
    ...
    // Find session by shareToken with all related data
    ...
    console.error("POST /api/assessments/sessions/by-token/[token]/complete error:", e);
